            ...
            fetch(`${apiURL}${ranUrlPage}${randomPage}`).then(function (data) {
                ...
                fetch(movieURL)
                    ...
                    .then(function (response) {
                        ...
                        $('#show_preview').append(`<iframe width="560" height="315" src="https://www.youtube.com/embed/I1vccr3yWBU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`)
