            ...
            fetch(`${apiURL}${ranUrlPage}${randomPage}`).then(function (data) {
                ...
                fetch(recURL)
                    ...
                    .then(function (query) {
                        ...
                        $('#show_Trailer').append(`<iframe id="youtube_player" class="yt_player_iframe width="560" height="315" src="${query.Similar.Info[0].yUrl}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen allowscriptaccess="always"></iframe>`)
                        }
                        else{
                            $('#show_Trailer').append(`
