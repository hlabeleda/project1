    ...
    fetch(apiURL)
        ...
        .then(function (data) {
            ...
            fetch(`${apiURL}${ranUrlPage}${randomPage}`).then(function (data) {
                ...
                $("#bg").css("background-image", `./assets/images/altheadshot.jpg`);
            }
...
var altBackImg = document.querySelector("#bg");
console.log("is background",altBackImg);

if ("background-image" === null) {
    altBackImg.setAttribute("style", "./assets/images/altheadshot.jpg");
