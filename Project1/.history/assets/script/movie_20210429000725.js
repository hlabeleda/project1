    ...
    fetch(apiURL)
        ...
        .then(function (data) {
            ...
            fetch(`${apiURL}${randomPage}`).then(function (data) {
                ...
                // appends the poster
                $('#show_poster').append(`
                <img src="https://www.themoviedb.org/t/p/w220_and_h330_face/${data.results[randomResult].poster_path}" class="card-img-top" onerror=this.src="./assets/images/altposter.jpg" style="max-width: fit-content; max-height:512px; border-radius:10px; margin-top: 30px;">
                 `);
                ...
                $(document).ready(function () {
                    $("#bg").css("background-image", `url(https://image.tmdb.org/t/p/w1920_and_h800_multi_faces/${data.results[randomResult].backdrop_path}) onerror=this.src="./assets/images/altposter.jpg"`);
                });
        //         $("body").append(`
        ...
        // //   </div>`);
            ...
            fetch(movieURL)
                ...
                .then(function (response) {
                    ...
                    $('#img_actor1').append(`
                        <img src="https://www.themoviedb.org/t/p/w138_and_h175_face/${response.credits.cast[0].profile_path}" class="card-img-top" onerror=this.src="./assets/images/altheadshot.jpg" style="max-width: fit-content; max-height:175px; border-radius:10px;">
                         `);
                    $('#img_actor2').append(`
                         <img src="https://www.themoviedb.org/t/p/w138_and_h175_face/${response.credits.cast[1].profile_path}" class="card-img-top" onerror=this.src="./assets/images/altheadshot.jpg" style="max-width: fit-content; max-height:175px; border-radius:10px;">
                          `);
                    $('#img_actor3').append(`
                        <img src="https://www.themoviedb.org/t/p/w138_and_h175_face/${response.credits.cast[2].profile_path}" class="card-img-top" onerror=this.src="./assets/images/altheadshot.jpg" style="max-width: fit-content; max-height:175px; border-radius:10px;">
                         `);
                    $('#img_actor4').append(`
                         <img src="https://www.themoviedb.org/t/p/w138_and_h175_face/${response.credits.cast[3].profile_path}" class="card-img-top" onerror=this.src="./assets/images/altheadshot.jpg" style="max-width: fit-content; max-height:175px; border-radius:10px;">
                          `);
                    $('#img_actor5').append(`
                          <img src="https://www.themoviedb.org/t/p/w138_and_h175_face/${response.credits.cast[4].profile_path}" class="card-img-top" onerror=this.src="./assets/images/altheadshot.jpg" style="max-width: fit-content; max-height:175px; border-radius:10px;">
                           `);
                    $('#img_actor6').append(`
                           <img src="https://www.themoviedb.org/t/p/w138_and_h175_face/${response.credits.cast[5].profile_path}" class="card-img-top" onerror=this.src="./assets/images/altheadshot.jpg" style="max-width: fit-content; max-height:175px; border-radius:10px;">
                            `);       
