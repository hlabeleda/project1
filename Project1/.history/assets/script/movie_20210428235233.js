    ...
    fetch(apiURL)
        ...
        .then(function (data) {
            ...
            fetch(`${apiURL}${randomPage}`).then(function (data) {
                ...
                // appends the poster
                $('#show_poster').append(`
                <img src="https://ww.themoviedb.org/t/p/w220_and_h330_face/${data.results[randomResult].poster_path}" class="card-img-top" onerror=this.src="./assets/images/altposter.jpg" style="max-width: fit-content; max-height:512px; border-radius:10px; margin-top: 30px;">
                 `);
