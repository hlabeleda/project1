        ...
        // //   </div>`);
            ...
            fetch(movieURL)
                ...
                .then(function (response) {
                    ...
                    $('#img_actor1').append(`
                        <img src="https://www.themoviedb.org/t/p/w138_and_h175_face/${response.credits.cast[0].profile_path}" class="card-img-top" alt="Image not found" style="max-width: fit-content; max-height:175px; border-radius:10px;">
                         `);
                    $('#img_actor2').append(`
